...
var BoardsORM = {
	dbName: "ZEUS_TASKS_BOARD",
	properties: [
		{
			name: "id",
			dbName: "ZEUS_TASKSB_ID",
			id: true,
			required: true,
			type: "Long"
		},{
			name: "shortText",
			dbName: "ZEUS_TASKSB_SHORT_TEXT",
			type: "String",
			size: 500
		},{
			name: "description",
			dbName: "ZEUS_TASKSB_DESCRIPTION",
			type: "String",
			size: 10000
		},{
			name: "publishTime",
			dbName: "ZEUS_TASKSB_PUBLISH_TIME",
			required: true,
			type: "Long",
			...
			dbName: "ZEUS_TASKSB_LASTMODIFIED_TIME",
			type: "Long",
